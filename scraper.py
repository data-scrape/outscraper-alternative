#!/usr/bin/env python3
"""
outscraper-alternative - Outscraper to CoreClaw Migration Demo

This script demonstrates how to migrate from Outscraper to CoreClaw's Web Data API.
...
class OutscraperAlternative:
    """Demo: Migrate from Outscraper to CoreClaw Web Data API."""
...
def main():
    parser = argparse.ArgumentParser(description="outscraper-alternative - Outscraper to CoreClaw Migration")
    ...
    client = OutscraperAlternative(api_key=args.api_key)
